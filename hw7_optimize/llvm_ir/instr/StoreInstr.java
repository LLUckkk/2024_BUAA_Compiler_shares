...
public class StoreInstr extends Instr {
    ...
    public void toMips() {
        ...
        if (to instanceof GlobalVar) {
            ...
            int offset = MipsManager.getInstance().findOffset(to);
        ...
        if (from instanceof GlobalVar) {
            ...
            if (from.getType().isChar8()) {
                new MemoryAsmb(MemoryAsmb.MemoryOp.LB, fromReg, 0, fromReg);
            } else {
        ...
        } else if (from instanceof Undefined) {
            new LiAsmb(fromReg, 0);
        } else {
