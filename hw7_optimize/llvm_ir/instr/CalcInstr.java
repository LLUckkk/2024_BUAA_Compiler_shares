...
public class CalcInstr extends Instr {
    ...
    public void toMips() {
        ...
        } else if (operand1 instanceof Constant || operand1 instanceof Undefined) {
            int imm = 0;
            if (operand1 instanceof Constant) {
                imm = ((Constant) operand1).getValue();
            }
            new LiAsmb(op1, imm);
        ...
        } else if (operand2 instanceof Constant || operand2 instanceof Undefined) {
            int imm = 0;
            if (operand2 instanceof Constant) {
                imm = ((Constant) operand2).getValue();
            }
            new LiAsmb(op2, imm);
