...
public class CalcInstr extends Instr {
    ...
    public void createAluIAsmb(CalcInstr.Op op, Register dest, Register op1, int imm) {
        Register op2;
        switch (op) {
            case ADD:
    ...
    public void createAluAsmb(CalcInstr.Op op, Register dest, Register op1, Register op2) {
        switch (op) {
            case ADD:
                new AluAsmb(AluAsmb.AluOp.ADD, dest, op1, op2);
                break;
            case SUB:
                new AluAsmb(AluAsmb.AluOp.SUB, dest, op1, op2);
                break;
            case MUL:
                new MDAsmb(MDAsmb.MDop.MULT, op1, op2);
                new HiLoAsmb(HiLoAsmb.HLop.MFLO, dest);
    ...
    public void createLiAsmb(CalcInstr.Op op, Register dest, int val1, int val2) {
        switch (op) {
            case ADD:
